...
public class ExceptionHandler {
 ...
 @org.springframework.web.bind.annotation.ExceptionHandler(InvalidCategory.class)
    public ResponseEntity<CustomException> handleInvalidCategoryException(InvalidCategory except){
	 	CustomException custom = new CustomException();
	 	custom.setUserMessage(except.getMessage());
	 	custom.setDeveloperMessage(except.getLocalizedMessage());
	 	custom.setStatusCode(404);
